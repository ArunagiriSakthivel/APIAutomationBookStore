...
public class BookStoreApiTests extends ExtentReports {
    ...
    public void testCreateBook() {
        ...
        BookModel book = new BookModel("API Testing with RestAssured", "QA Author", 2023);
        Response response = given()
                .contentType(ContentType.JSON)
                .body(book)
    ...
    public void testUpdateBook() {
        ...
        BookModel updatedBook = new BookModel("Updated Title", "Updated Author", 2024);
